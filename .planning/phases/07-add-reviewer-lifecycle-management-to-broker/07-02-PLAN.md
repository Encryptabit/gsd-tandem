...
<success_criteria>
ReviewerPool can spawn, drain, and terminate reviewer subprocesses with full audit trail. stdout/stderr are DEVNULL (no pipe deadlock). DB write failures terminate orphan processes. Platform-aware argv builder produces correct commands for Windows (WSL) and native platforms. No subprocess uses shell=True.
</success_criteria>
