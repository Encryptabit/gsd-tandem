...
```bash
npm view get-shit-done-tandem version 2>/dev/null
```
...
To update manually: `npx get-shit-done-tandem --global`
```
...
**If LOCAL install:**
```bash
npx get-shit-done-tandem --local
```

**If GLOBAL install (or unknown):**
```bash
npx get-shit-done-tandem --global
```
...
[View full changelog](https://github.com/Encryptabit/gsd-tandem/blob/main/CHANGELOG.md)
```
</step>
